	...
	<div class="card card-outline rounded-0 card-navy">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control form-control-sm" name="address" id="" value="<?php echo  $_settings->info('address') ?>">
	            
			</div>
			<div class="form-group">
				<label for="" class="control-label">Contact</label>
				<input type="text" class="form-control form-control-sm" name="contact" id="" value="<?php echo  $_settings->info('contact') ?>">
