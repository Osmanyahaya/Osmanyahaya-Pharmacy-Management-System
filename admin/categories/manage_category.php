...
<div class="content py-5 px-3 bg-gradient-info">
	<h2><b><?= isset($cat_id) ? "Update Category Details" : "New Category Entry" ?></b></h2>
</div>
				...
				<div class="container-fluid">
					<form action="" id="category-form">
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" name="cat_name" id="name" class="form-control form-control-sm rounded-0" value="<?php echo isset($cat_name) ? $cat_name : ''; ?>"  required/>
						</div>
