        ...
        <div class="container-fluid" id="printout">
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
                    ...
                    $total = 0;
					$i = 1;
                    $qry = $conn->query("SELECT * from stock_list where date(date_created) BETWEEN '{$from}' and '{$to}' order by date_created desc");
					...
					?>
						<tr>
                            ...
                            <td align="center">
                                <a class="btn btn-default bg-gradient-light btn-flat btn-sm" href="?page=reports/stock_details&id=<?php echo $row['sid'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
                            </td>
						</tr>
					<?php endwhile; ?>
				</tbody>
                <tfoot>
                    <th class="py-1 text-center" colspan="3">Total Stock</th>
...
<script>
	$(document).ready(function(){
		$('#filter-form').submit(function(e){
            e.preventDefault()
            location.href = "./?page=reports/stockin_list&"+$(this).serialize()
        })
