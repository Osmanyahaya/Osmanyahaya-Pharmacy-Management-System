	...
	<div class="card-body">
		<div class="container-fluid mb-3">
            <fieldset class="px-2 py-1 border">
                <legend class="w-auto px-3"> Filter Product and Date Range</legend>
                <div class="container-fluid">
                    <form action="" id="filter-form">
                        <div class="row align-items-end">
                            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="date" class="control-label">Product</label>
                                    
                                        <select name="prod" id="product_sel" class="form-control form-control-sm rounded">
        ...
        <div class="container-fluid" id="printout">
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
                    ...
                    $totalqty=0;
					$i = 1;
                    $qry = $conn->query("SELECT sk.*,sl.sid, pl.prod_name as product,sl.date_created FROM `stockin` sk inner join stock_list sl on sk.stockin_id = sl.sid inner join product pl on sk.prod_id = pl.prod_id where date(sl.date_created) BETWEEN '{$from}' and '{$to}' and sk.prod_id= '{$prod}' order by sl.date_created desc  ");
                ...
                <tfoot>
                    <th class="py-1 text-right" colspan="5">Totals</th>
                     <th class="py-1 text-right"><?= $totalqty ?></th>
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            <div style="line-height:1em">
                ...
                <h4 class="text-center mb-0"><b>Sales Report of<?php echo $prod ?> as of <?= date("F d, Y", strtotime($from)) ?> to <?= date("F d, Y", strtotime($to)) ?> </b></h4>
...
<script>
	$(document).ready(function(){
		$('#filter-form').submit(function(e){
            e.preventDefault()
            location.href = "./?page=reports/single_prod_purchase_report&"+$(this).serialize()
        })
        $('#product_sel').select2({
