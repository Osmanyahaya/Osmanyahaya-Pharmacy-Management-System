...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">Transactions List of
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					...
					$user=$_settings->userdata('id');
						...
						$qry = $conn->query("SELECT * FROM `transaction_list` WHERE user_id='$user' order by unix_timestamp(date_updated) desc limit 190");
