            ...
            <div class="col-md-6">
              <div class="card card-info">
                <div class="card-header with-border">
                  <h3 class="card-title">Search Existing Supplier</h3>
                </div>
                <div class="card-body">
                
                <form method="post" action="<?php echo base_url ?>admin/?page=patient/pharm_cart" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <select class="form-control select2" style="width: 100%;" name="cid" required>
                         <option value="0" selected="selected" disabled>Click to Search for Supplier</option>
                      <?php
                       include('../dist/includes/dbcon.php');
                        $query2=$conn->query("select * from supplier");
